...
This directory contains the live design and product-support documents for Manifold's April 13, 2026 product model.
...
- [../docs/getting-started.md](../docs/getting-started.md) — quickest path from clone to a governed session
...
- [../CONTRIBUTING.md](../CONTRIBUTING.md) — setup, verification, and pull request guidance
