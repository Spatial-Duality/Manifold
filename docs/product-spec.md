...
- [apple-design-excellence-guide.md](apple-design-excellence-guide.md)
- [runtime-migration.md](runtime-migration.md)
- [menu-bar-spec.md](menu-bar-spec.md)
- [email-controls-spec.md](email-controls-spec.md)
- [why-runtime.md](why-runtime.md)
- [archive/UI-BACKEND-GAP-AUDIT.md](archive/UI-BACKEND-GAP-AUDIT.md)
- [archive/RUNTIME-ARCHITECTURE-PLAN.md](archive/RUNTIME-ARCHITECTURE-PLAN.md)
- [archive/APP-QUALITY-ROADMAP.md](archive/APP-QUALITY-ROADMAP.md)

Historical design iterations are archived under [archive/design-iterations/](archive/design-iterations/).
